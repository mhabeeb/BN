...
Namespace MyCompany.Security
    ...
    Public Class EventTrackerBase
        ...
        Private Shared m_ModifiedByUserIdRegex As Regex = New Regex("Updated_By", RegexOptions.IgnoreCase)
        
        Private Shared m_ModifiedOnRegex As Regex = New Regex("Updated_DateTime", RegexOptions.IgnoreCase)
        
        Private Shared m_CreatedByUserNameRegex As Regex = Nothing
        
        Private Shared m_CreatedByUserIdRegex As Regex = New Regex("Created_By", RegexOptions.IgnoreCase)
        
        Private Shared m_CreatedOnRegex As Regex = New Regex("Created_DateTime", RegexOptions.IgnoreCase)
