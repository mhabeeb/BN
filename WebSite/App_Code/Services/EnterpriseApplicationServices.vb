...
Namespace MyCompany.Services
    ...
    Public Class EnterpriseApplicationServicesBase
        ...
        Public Overrides Sub RegisterServices()
            ...
            OAuthHandlerFactory.Handlers.Add("facebook", GetType(FacebookOAuthHandler))
            OAuthHandlerFactory.Handlers.Add("google", GetType(GoogleOAuthHandler))
            OAuthHandlerFactory.Handlers.Add("msgraph", GetType(MSGraphOAuthHandler))
            OAuthHandlerFactory.Handlers.Add("windowslive", GetType(WindowsLiveOAuthHandler))
            OAuthHandlerFactory.Handlers.Add("sharepoint", GetType(SharePointOAuthHandler))
            OAuthHandlerFactory.Handlers.Add("identityserver", GetType(IdentityServerOAuthHandler))
        End Sub
