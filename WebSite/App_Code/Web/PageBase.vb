...
Namespace MyCompany.Web
    ...
    Public Class PageBaseCore
        ...
        Protected Overrides Sub Render(ByVal writer As HtmlTextWriter)
            ...
            tempWriter.Flush()
            tempWriter.Close()
            Dim page As String = MyCompany.Data.Localizer.Replace("Pages", Path.GetFileName(Request.PhysicalPath), sb.ToString())
            If page.Contains("data-content-framework=""bootstrap""") Then
                ...
                Else
                    page = Regex.Replace(page, "\/>\s*<title>", (("/><link href=""" + ResolveClientUrl("~/css/sys/bootstrap.css"))  _
