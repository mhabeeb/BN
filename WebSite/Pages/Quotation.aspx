...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    ...
    <div id="view4" data-controller="View_Item_Reservation" data-view="grid1" data-filter-source="view2" data-filter-fields="LineID" data-page-size="5" data-show-view-selector="false" data-auto-hide="self" data-show-modal-forms="true" data-visible-when="[Master.QT_Qty] > 0"></div>
    <div data-activator="Tab|^StoreStock^Store Stock^StoreStock^">
      <div id="view3" data-controller="View_Store_Stock" data-view="grid1" data-filter-source="view2" data-filter-fields="Item_Code" data-page-size="5" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
  </div>
</asp:Content>