...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    <div id="view1" data-controller="COA_Natural_Account" data-show-in-summary="true" data-show-view-selector="false" data-auto-highlight-first-row="true"></div>
    ...
    <div data-activator="Tab|Sub Account">
      <div id="view5" data-controller="COA_Sub_Account_Dependent" data-view="grid1" data-filter-source="view1" data-filter-fields="AccountID,Company_Code" data-page-size="5" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
  </div>
</asp:Content>