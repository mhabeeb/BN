...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    ...
    <div id="view2" data-controller="TBL_DocumetTypes_Child" data-view="grid1" data-filter-source="view1" data-filter-fields="DocTypeID" data-page-size="5" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true"></div>
  </div>
</asp:Content>