<%@ Page Language="VB" MasterPageFile="~/Main.Master" AutoEventWireup="false" CodeFile="MultiLineReceipts.aspx.vb" Inherits="Pages_MultiLineReceipts"  Title="Multi Line Receipts" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageTitleContentPlaceHolder" runat="Server">Multi Line Receipts</asp:Content>
