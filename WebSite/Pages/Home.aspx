<%@ Page Language="VB" MasterPageFile="~/Main.Master" AutoEventWireup="false" CodeFile="Home.aspx.vb" Inherits="Pages_Home"  Title="^WorNot^Workflow Notification^WorNot^" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageTitleContentPlaceHolder" runat="Server">^WorNot^Workflow Notification^WorNot^</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="column" data-width="70%">
    ...
    <div data-activator="Tab|^NotCom^Notification Comments^NotCom^">
    ...
    <div data-activator="Tab|View Line Details">
      <div id="view5" data-controller="XX_Email_View" data-view="grid1" data-filter-source="view1" data-filter-fields="DocumentID" data-page-size="5" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
  </div>
