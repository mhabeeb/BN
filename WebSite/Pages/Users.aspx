...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    ...
    <div data-activator="Tab|^UserProjects^User Projects^UserProjects^">
      <div id="view4" data-controller="UserProjectAccess" data-view="grid1" data-filter-source="view1" data-filter-fields="UserID" data-page-size="5" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
    ...
    <div data-activator="Tab|^ConsolidationAccess^Consolidation Access^ConsolidationAccess^">
      <div id="view8" data-controller="UserConsolidationAccess" data-view="grid1" data-filter-source="view1" data-filter-fields="UserID" data-page-size="5" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
    <div data-activator="Tab|^AppGroAcc^Approval Group Acces^AppGroAcc^">
      <div id="view9" data-controller="UserApprovalGroupAccess" data-view="grid1" data-filter-source="view1" data-filter-fields="UserID" data-page-size="5" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
    <div data-activator="Tab|^CrossValidations^CrossValidations^CrossValidations^">
      <div id="view10" data-controller="UserCrossValidationAccess" data-view="grid1" data-filter-source="view1" data-filter-fields="UserID" data-page-size="5" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
  </div>
</asp:Content>