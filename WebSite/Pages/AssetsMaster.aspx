...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    ...
    <div data-activator="Tab|^FALocation^FA Location^FALocation^">
      <div id="view4" data-controller="FA_Location" data-show-view-selector="false"></div>
    </div>
    <div data-activator="Tab|^AssetsAsignments^Assets Asignments^AssetsAsignments^">
      <div id="view5" data-controller="FA_Assets_Assignments" data-view="grid1" data-filter-source="view1" data-filter-fields="AssetID" data-page-size="5" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
    <div data-activator="Tab|^CostAdjustment^Cost Adjustment^CostAdjustment^">
      <div id="view6" data-controller="Assets_CostAdjustments" data-view="grid1" data-filter-source="view1" data-filter-fields="AssetID,BookID" data-page-size="5" data-show-modal-forms="true"></div>
    </div>
  </div>
</asp:Content>