...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    <div id="view1" data-controller="ItemLedger" data-show-in-summary="true" data-show-view-selector="false"></div>
    <div class="DataViewHeader">^ViewInventoryTransactions^View Inventory Transactions^ViewInventoryTransactions^</div>
    <div id="view2" data-controller="View_Inventory_Lines" data-view="grid1" data-filter-source="view1" data-filter-fields="Item_Code" data-page-size="5" data-show-modal-forms="true"></div>
  </div>
</asp:Content>