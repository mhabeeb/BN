...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    <div id="view1" data-controller="tbl_CompanyInformation" data-show-view-selector="false" data-show-modal-forms="true" data-auto-highlight-first-row="true"></div>
    ...
    <div data-activator="Tab|^DimensionSetup^Dimension Setup^DimensionSetup^">
      <div id="view3" data-controller="Accouting_Dimensions" data-view="grid1" data-filter-source="view1" data-filter-fields="Company_Code" data-page-size="5" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
