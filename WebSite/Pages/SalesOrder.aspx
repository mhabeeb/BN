...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    <div id="view1" data-controller="SO_Header" data-show-in-summary="true" data-show-action-buttons="top" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true" data-show-details-in-list-mode="false" data-auto-highlight-first-row="true"></div>
    ...
    <div id="view9" data-controller="View_Item_Reservation" data-view="grid1" data-filter-source="view2" data-filter-fields="SO_Line_No" data-page-size="5" data-show-view-selector="false" data-auto-hide="self" data-show-modal-forms="true"></div>
    <div data-activator="Tab|^Customerlocation^Customer Locations^Customerlocation^">
      <div id="view10" data-controller="tbl_Locations" data-view="grid1" data-filter-source="view1" data-filter-fields="Sys_Number" data-page-size="5" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
  </div>
</asp:Content>