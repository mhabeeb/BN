...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    <div id="view1" data-controller="Inventory_Physical_Header" data-show-modal-forms="true"></div>
    <div id="view2" data-controller="Inventory_Pysical_Line" data-view="grid1" data-filter-source="view1" data-filter-fields="PhysicalCountID" data-page-size="5" data-show-modal-forms="true"></div>
  </div>
</asp:Content>