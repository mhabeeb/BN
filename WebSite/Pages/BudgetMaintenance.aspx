...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row" style="padding-top:8px">
    <div id="view1" data-controller="GL_Budget_Master" data-show-in-summary="true" data-show-view-selector="false" data-auto-highlight-first-row="true"></div>
    ...
    <div data-activator="Tab|View Invoice">
      <div id="view7" data-controller="View_Invoice_Bud" data-view="grid1" data-filter-source="view1" data-filter-fields="BudgetCode" data-page-size="5" data-show-modal-forms="true"></div>
    </div>
  </div>
</asp:Content>