...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    ...
    <div data-activator="Tab|^BOQLines^BOQ Lines^BOQLines^">
      <div id="view2" data-controller="SOBOQ_Line_Items" data-view="grid1" data-show-in-summary="true" data-filter-source="view1" data-filter-fields="SO_NO,Project_Code,Dept_Code" data-page-size="5" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
    <div data-activator="Tab|^PurchaseOrders^Purchase Orders^PurchaseOrders^">
      <div id="view7" data-controller="View_PO_Lines" data-view="grid1" data-filter-source="view1" data-page-size="5" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
    <div data-activator="Tab|^Requsitions^Requsitions^Requsitions^">
      <div id="view4" data-controller="View_PR_Lines" data-view="grid1" data-filter-source="view1" data-page-size="5" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
    <div data-activator="Tab|^InventoryTransaction^Inventory Transaction^InventoryTransaction^">
      <div id="view5" data-controller="View_Inventory_Lines" data-filter-source="view1" data-page-size="5" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
    <div data-activator="Tab|^Invoices^Invoices^Invoices^">
      <div id="view6" data-controller="View_Invoice_Lines" data-view="grid1" data-filter-source="view1" data-page-size="5" data-show-view-selector="false" data-show-modal-forms="true"></div>
    </div>
