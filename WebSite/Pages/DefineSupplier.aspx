...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    <div id="view1" data-controller="SupplierMaster" data-show-in-summary="true" data-page-size="10" data-show-description="false" data-show-view-selector="false" data-show-modal-forms="true" data-show-details-in-list-mode="false" data-auto-highlight-first-row="true"></div>
    ...
    <div data-activator="Tab|^SupplierLocations^Supplier Locations^SupplierLocations^">
    ...
    <div class="DataViewHeader">Supplier Location Account</div>
    <div id="view8" data-controller="SYS_Default_Account_Loc" data-view="grid1" data-filter-source="view3" data-filter-fields="LocationID" data-page-size="5" data-auto-hide="self" data-show-modal-forms="true"></div>
  </div>
</asp:Content>