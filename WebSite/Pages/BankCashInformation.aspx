<%@ Page Language="VB" MasterPageFile="~/Main.Master" AutoEventWireup="false" CodeFile="BankCashInformation.aspx.vb" Inherits="Pages_BankCashInformation"  Title="^BankCashInformation^Bank Cash Information^BankCashInformation^" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageTitleContentPlaceHolder" runat="Server">^BankCashInformation^Bank Cash Information^BankCashInformation^</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    <div id="view1" data-controller="BankCashInformation" data-show-in-summary="true" data-show-view-selector="false" data-auto-highlight-first-row="true"></div>
    ...
    <div data-activator="Tab|^PayDocument^Pay Document^PayDocument^">
      <div id="view5" data-controller="tbl_Document_Sequencing_Bank" data-view="grid1" data-filter-source="view1" data-filter-fields="CashBankID" data-page-size="5" data-show-modal-forms="true"></div>
    </div>
  </div>
</asp:Content>